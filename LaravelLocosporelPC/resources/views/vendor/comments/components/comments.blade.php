...
@if($comments->count() < 1)
    <div class="alert alert-warning">Aún no hay comentarios</div>
@endif
...
@else
    <div class="card">
        <div class="card-body">
            <h5 class="card-title">Autentificación requerida</h5>
            <p class="card-text">Debes iniciar sesión para poner un comentario</p>
